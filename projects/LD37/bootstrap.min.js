var base=base||{};!function(){var a,b=!1;base.indexFunc=function(c){var d=[["image/tiles","assets/image/tiles.png","spritesheet",{frameWidth:32,frameHeight:32,pixelated:!0}],["image/turtle","assets/image/turtle.png","spritesheet",{frameWidth:32,frameHeight:32,pixelated:!0}],["program/level1","assets/program/level1.sbl","text"],["program/level2","assets/program/level2.sbl","text"],["program/level3","assets/program/level3.sbl","text"],["level/level1","assets/level/level1.json","tilemap"],["level/level2","assets/level/level2.json","tilemap"],["level/level3","assets/level/level3.json","tilemap"]];base.loadAssets(d.concat([["scripts/app","app.min.js","script"]])),a=new Image,a.onload=base.external(function(){b=!0}),a.src="assets/image/logo.png"},base.displayId="content",base.renderLoadingScreen=function(c,d,e){var f=document.getElementById(c);if(null!==f){var g=f.getContext("2d");if(null!==g){var h=g.canvas.width,i=g.canvas.height;g.fillStyle="#FFFFFF",g.fillRect(0,0,h,i),b&&g.drawImage(a,(h-a.width)/2,(i-a.height)/2),g.fillStyle="#000000",g.beginPath(),g.rect(20,i-40,h-40,20),g.stroke(),g.beginPath(),g.rect(20,i-40,e/(e+d)*(h-40),20),g.fill()}}}}();
/*
